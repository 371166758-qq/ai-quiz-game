...
const questions = [
    ...
    // 新增热门题目 - 2026-04-04
    {
        question: "中国四大发明不包括下列哪一项？",
        options: ["造纸术", "印刷术", "陶瓷", "火药"],
        answer: 2,
        explanation: "四大发明是造纸术、指南针、火药、印刷术，陶瓷不属于四大发明。"
    },
    {
        question: "世界上最长的河流是哪条？",
        options: ["长江", "尼罗河", "亚马逊河", "密西西比河"],
        answer: 1,
        explanation: "尼罗河全长约6650公里，是世界最长的河流。"
    },
    {
        question: "光年是什么单位？",
        options: ["时间单位", "距离单位", "速度单位", "质量单位"],
        answer: 1,
        explanation: "光年是距离单位，指光在真空中一年所走的距离，约9.46万亿公里。"
    },
    {
        question: "秦始皇统一中国是在哪一年？",
        options: ["公元前221年", "公元前206年", "公元221年", "公元前256年"],
        answer: 0,
        explanation: "公元前221年，秦始皇统一六国，建立中国历史上第一个统一王朝。"
    },
    {
        question: "人体最大的器官是什么？",
        options: ["心脏", "肝脏", "皮肤", "大脑"],
        answer: 2,
        explanation: "皮肤是人体最大的器官，成人皮肤面积约1.5-2平方米。"
    },
    {
        question: "以下哪个国家不是联合国安理会常任理事国？",
        options: ["中国", "德国", "法国", "英国"],
        answer: 1,
        explanation: "五常是中、美、俄、英、法，德国不是常任理事国。"
    },
    {
        question: "DNA的中文全称是什么？",
        options: ["核糖核酸", "脱氧核糖核酸", "氨基酸", "蛋白质"],
        answer: 1,
        explanation: "DNA即脱氧核糖核酸，是遗传信息的载体。"
    },
    {
        question: "丝绸之路的开辟者是谁？",
        options: ["郑和", "张骞", "玄奘", "班超"],
        answer: 1,
        explanation: "西汉张骞出使西域，开辟了丝绸之路。"
    },
    {
        question: "地球上最深的海沟是？",
        options: ["日本海沟", "菲律宾海沟", "马里亚纳海沟", "秘鲁-智利海沟"],
        answer: 2,
        explanation: "马里亚纳海沟最深处约11034米，是地球海洋最深处。"
    },
    {
        question: "以下哪种动物是哺乳动物？",
        options: ["鲨鱼", "鲸鱼", "海马", "水母"],
        answer: 1,
        explanation: "鲸鱼是哺乳动物，用肺呼吸，胎生哺乳。"
    }
];
